...
public interface StockIdDBOperation {
  ...
  // List<StockId> setStockIds(@RequestParam List<StockId> stocks) throws JsonProcessingException;
  ...
  // @ResponseStatus(value = HttpStatus.OK)
  // Boolean deleteStockId(@RequestParam (name = "stocks") List<StockId> stocks) throws JsonProcessingException;
